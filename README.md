...
2. [Install Russian Language Pack](#2-how-to-install-hungarian-language-pack)
3. [How to active Russian language pack](#3-how-to-active-hungarian-language-pack)
...
## 3. How to active Russian language pack {#active}
